...
def create_enemy():
    enemy = pygame.transform.scale(pygame.image.load('enemy.png').convert_alpha(), (SIZE_ENEMY))
    enemy_rect = pygame.Rect(WIDTH, random.randint((HEIGHT / 4), (3*HEIGHT/4)), *SIZE_ENEMY)
