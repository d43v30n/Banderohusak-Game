...
while playing:
    ...
    for event in pygame.event.get():
        ...
        if event.type == CHANGE_IMAGE:
            ...
            image_index = image_index + image_flag
            if image_index == len(PLAYER_IMAGES) or image_index == 0: 
    ...
    main_display.blit(FONT.render(str(score), True, (0, 0, 0)), (WIDTH-50, 20))
